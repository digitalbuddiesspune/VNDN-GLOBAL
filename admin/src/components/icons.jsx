...
function Icon({ className = iconClass, children }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function IconBanner({ className = iconClass }) {
  return (
    <Icon className={className}>
...
export function IconProperties({ className = iconClass }) {
  return (
    <Icon className={className}>
...
export function IconUsersNav({ className = iconClass }) {
  return (
    <Icon className={className}>
...
export function IconInquiries({ className = iconClass }) {
  return (
    <Icon className={className}>
...
export function IconBuilding({ className = iconClass }) {
  return (
    <Icon className={className}>
...
export function IconRevenue({ className = iconClass }) {
  return (
    <Icon className={className}>
